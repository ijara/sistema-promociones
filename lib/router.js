...
FlowRouter.route('/solicitudes',{
  name:'solicitudes',
  action(){
      BlazeLayout.render('MainLayout',{main:'Solicitudes'})
  }
});
FlowRouter.route('/nuevasolicitud',{
  name:'nuevasolicitud',
  action(){
      BlazeLayout.render('MainLayout',{main:'NuevaSolicitud'})
  }
});
